...
typedef enum UiAction
{
    ...
    UI_ACTION_START_STRUCTURE_BUILDER,
    UI_ACTION_SELECT_CREATIVE_TILE,
    UI_ACTION_SELECT_SURVIVAL_TILE,
    UI_ACTION_SAVE_STRUCTURE,
    UI_ACTION_OPEN_STRUCTURE_BROWSER,
    UI_ACTION_SELECT_STRUCTURE_ENTRY,
    UI_ACTION_SAVE_STRUCTURE_SETTINGS,
    UI_ACTION_EDIT_STRUCTURE_ENTRY,
    UI_ACTION_EXIT,
